...
if [[ ${MTLS_CONFIG_OPS_1} == "permissive" && ${MTLS_CONFIG_OPS_2} == "permissive" ]]; then
    ...
    print_and_execute "cp -r ${WORKDIR}/asm/k8s_manifests/prod/app-mtls/mtls-kustomize-patch-replicated.yaml ${WORKDIR}/k8s-repo/${OPS_GKE_1_CLUSTER}/istio-controlplane/mtls-kustomize-patch"
    ...
    print_and_execute "cp -r ${WORKDIR}/asm/k8s_manifests/prod/app-mtls/mtls-kustomize-patch-replicated.yaml ${WORKDIR}/k8s-repo/${OPS_GKE_2_CLUSTER}/istio-controlplane/mtls-kustomize-patch"
    print_and_execute "cd ${WORKDIR}/k8s-repo/${OPS_GKE_2_CLUSTER}/istio-controlplane"
    print_and_execute "kustomize edit add patch mtls-kustomize-patch.yaml"
    echo -e "\n"

    title_no_wait "For ${DEV1_GKE_1_CLUSTER} cluster:"
    print_and_execute "cp -r ${WORKDIR}/asm/k8s_manifests/prod/app-mtls/mtls-kustomize-patch-shared.yaml ${WORKDIR}/k8s-repo/${DEV1_GKE_1_CLUSTER}/istio-controlplane/mtls-kustomize-patch"
    print_and_execute "cd ${WORKDIR}/k8s-repo/${DEV1_GKE_1_CLUSTER}/istio-controlplane"
    print_and_execute "kustomize edit add patch mtls-kustomize-patch.yaml"
    echo -e "\n"

    title_no_wait "For ${DEV1_GKE_2_CLUSTER} cluster:"
    print_and_execute "cp -r ${WORKDIR}/asm/k8s_manifests/prod/app-mtls/mtls-kustomize-patch-shared.yaml ${WORKDIR}/k8s-repo/${DEV1_GKE_2_CLUSTER}/istio-controlplane/mtls-kustomize-patch"
    print_and_execute "cd ${WORKDIR}/k8s-repo/${DEV1_GKE_2_CLUSTER}/istio-controlplane"
    print_and_execute "kustomize edit add patch mtls-kustomize-patch.yaml"
    echo -e "\n"

    title_no_wait "For ${DEV2_GKE_1_CLUSTER} cluster:"
    print_and_execute "cp -r ${WORKDIR}/asm/k8s_manifests/prod/app-mtls/mtls-kustomize-patch-shared.yaml ${WORKDIR}/k8s-repo/${DEV2_GKE_1_CLUSTER}/istio-controlplane/mtls-kustomize-patch"
    print_and_execute "cd ${WORKDIR}/k8s-repo/${DEV2_GKE_1_CLUSTER}/istio-controlplane"
    print_and_execute "kustomize edit add patch mtls-kustomize-patch.yaml"
    echo -e "\n"

    title_no_wait "For ${DEV2_GKE_2_CLUSTER} cluster:"
    print_and_execute "cp -r ${WORKDIR}/asm/k8s_manifests/prod/app-mtls/mtls-kustomize-patch-shared.yaml ${WORKDIR}/k8s-repo/${DEV2_GKE_2_CLUSTER}/istio-controlplane/mtls-kustomize-patch"
