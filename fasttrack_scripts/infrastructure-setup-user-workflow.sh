...
read -p ''
echo -e "Getting Istio Pods in ops-1 cluster..."
print_and_execute "kubectl --context ${OPS_GKE_1} get pods -n istio-system"
echo -e "\n"
echo -e "Getting Istio Pods in ops-2 cluster..."
...
read -p ''
echo -e "Getting Istio Pods in app-1 cluster in dev1 project..."
print_and_execute "kubectl --context ${DEV1_GKE_1} get pods -n istio-system"
echo -e "\n"
echo -e "Getting Istio Pods in app-2 cluster in dev1 project..."
print_and_execute "kubectl --context ${DEV1_GKE_2} get pods -n istio-system"
echo -e "\n"
echo -e "Getting Istio Pods in app-3 cluster in dev2 project..."
print_and_execute "kubectl --context ${DEV2_GKE_1} get pods -n istio-system"
echo -e "\n"
echo -e "Getting Istio Pods in app-4 cluster in dev2 project..."
